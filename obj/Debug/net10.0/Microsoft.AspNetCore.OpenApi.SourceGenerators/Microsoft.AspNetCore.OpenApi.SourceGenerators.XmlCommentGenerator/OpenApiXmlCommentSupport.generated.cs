...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"T:backend_netcore_dotnet06.Migrations.init", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:backend_netcore_dotnet06.Migrations.update_table_Product", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
            cache.Add(@"T:backend_netcore_dotnet06.Migrations.update_product_table", new XmlComment(@"A base class inherited by each EF Core migration.", null, @"See <see href=""https://aka.ms/efcore-docs-migrations"">Database migrations</see> for more information and examples.", null, null, false, null, null, null));
